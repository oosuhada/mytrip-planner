...
('plan-rest-chidoritei', (SELECT id FROM trips WHERE title='Kyoto · Osaka 2026' LIMIT 1), 'Chidoritei', 'Kyoto', '2026-09-14', '13:40', '11:00–17:00 · 목요일 휴무', '약 ¥2,000–¥2,999/인 · 교토 스시 세트 후기 ¥2,730', 'WALK-IN ONLY', 'WALK-IN', 'walk-in / 전화 확인', 'https://tabelog.com/kyoto/A2601/A260301/26000570/', 'Tabelog 3.61 · 리뷰 245. 1899년부터 이어진 교토식 스시 평판이 강하고 1인 ¥3,000 안쪽 세트가 있어 9/14 늦은 점심 품질 우선 후보.', 'Domenic은 고등어·도미 등 생선 스시 중심으로 주문하고 비생선 해산물은 제외.', 303),
...
('plan-rest-kix-kineya', (SELECT id FROM trips WHERE title='Kyoto · Osaka 2026' LIMIT 1), 'KINEYA MUGIMARU KIX T1', 'KIX', '2026-09-17', '09:00', '07:00–22:00 · KIX T1 보안검색 전', '≤¥999 메뉴 포함 · 대체로 ¥1,000–¥1,999 · 1인 총액 ≤¥3,000', 'WALK-IN ONLY', 'WALK-IN', 'airport walk-in', 'https://www.kansai-airport.or.jp/en/dine/', 'Tabelog 3.29 · 리뷰 93. KIX T1 2F 보안검색 전에서 07:00부터 영업하고, 공항 내 후보 중 가격·평가·시간 균형이 좋아 출국 전 아침 기본 선택.', 'Domenic은 비생선 해산물 토핑 제외, Oosu는 매운 토핑 제외.', 340),
...
UPDATE meal_slots SET selected_restaurant_id='plan-rest-kix-kineya', updated_at=CURRENT_TIMESTAMP WHERE id='meal-0917-airport-sushi';
...
('meal-0917-airport-sushi','plan-rest-kix-kineya',10),
('meal-0917-airport-sushi','plan-rest-kix-nishiya',60),

...
('plan-rest-rikuro-namba', (SELECT id FROM trips WHERE title='Kyoto · Osaka 2026' LIMIT 1), 'Rikuro’s Namba Main Store', 'Osaka', '2026-09-15', '16:00', '1F 09:00–20:00 / 2F cafe 11:00–17:30, L.O. 16:30', 'Tabelog ¥1,000–¥1,999/인 · 1인 총액 ≤¥3,000', 'WALK-IN ONLY', 'WALK-IN', 'walk-in / takeout', 'https://www.rikuro.co.jp/shoplist/134.html', 'Tabelog 3.51 · 리뷰 1,482. 난바 대표 치즈케이크로 후기 모수가 크고 가격도 낮아 9/15 오후 디저트 기본 선택. 카페 마감이 빠르면 테이크아웃.', '치즈케이크 중심이라 해산물/매운맛 제한과 충돌 없음.', 50),
...
('plan-rest-saryo-tsujiri-gion', (SELECT id FROM trips WHERE title='Kyoto · Osaka 2026' LIMIT 1), 'Saryo Tsujiri Gion Main Store', 'Kyoto', NULL, NULL, '10:30–20:30, L.O. 19:30', 'Tabelog ¥1,000–¥1,999/인 · 1인 총액 ≤¥3,000', 'WALK-IN ONLY', 'WALK-IN', 'walk-in', 'https://www.giontsujiri.co.jp/store/saryotsujiri-honten/', 'Tabelog 3.55 · 리뷰 1,107. 말차·호지차 파르페/빙수 후기 모수가 크고 Gion Shijo 도보권이라 9/14 디저트 기본 선택.', '디저트 중심. 식품 알레르기/성분은 현장 메뉴 확인.', 180),
...
('plan-rule-food', (SELECT id FROM trips WHERE title='Kyoto · Osaka 2026' LIMIT 1), 'rules', 'Food rules', '하한 없음 · 1인 총액 ¥3,000 이하', '가격 하한은 없다. ¥500·¥800처럼 더 저렴해도 후기와 음식 평가가 좋으면 적극 우선한다. 1인 총액만 ¥3,000을 넘지 않게 잡고, 그 안에서 Tabelog 등 현지 평가·리뷰 수·원물/조리 퀄리티·동선을 우선한다. 회전초밥 대형체인과 1인 ¥3,000 초과 위험이 있는 곳은 기본 선택이 아니라 PLAN B로 둔다. Domenic은 우니·생선 외 해산물·내장 제외, Oosu는 매운 음식 제외.', 30),
...
('plan-rest-inoichi-hanare', (SELECT id FROM trips WHERE title='Kyoto · Osaka 2026' LIMIT 1), 'Menya Inoichi Hanare', 'Kyoto', NULL, NULL, '11:00–14:30 / 17:30–21:00', 'Tabelog ¥1,000–¥1,999 중심 · 1인 총액 ≤¥3,000', 'WALK-IN ONLY', 'WALK-IN', '당일 정리권', NULL, 'Tabelog 3.67 · 리뷰 854 · 라멘 WEST 백명점 2025. 9/14 늦은 저녁 기본 선택. 예약은 없고 디너 17:00부터 정리권 배포라 품절·대기 시 다른 라멘으로 전환.', '기본 dashi ramen은 생선 절 기반. Domenic은 가리비 덮밥 등 생선 외 해산물 사이드를 피하고, Oosu는 spicy dashi가 아닌 기본 메뉴 선택.', 230),
